            ...
            D = function (e) {
                ...
                return Object(r.c)(t, e), t.prototype.setAxis = function (t) {
                    ...
                    if (m.isNumber(n.x) && m.isNumber(n.y) && e.element) {
                        ...
                        e.path = h.moveTo({x: l * u.cos(r), y: l * u.sin(r)}) + h.lineTo({
                            x: a * u.cos(r),
                            y: a * u.sin(r)
                        })
                    }
                    ...
                    if (e.prototype.validate.call(this), !this.isTemplate) {
                        ...
                        if (this.middleLine.tensionX = D, this.middleLine.tensionY = I, m.isNumber(s) && m.isNumber(t) && m.isNumber(n) && m.isNumber(i) && m.isNumber(r)) {
                            ...
                            this.middleLine.segments = [
                                [{x: b, y: C}, {x: w, y: N}, {x: F, y: Y}, {x: P, y: A}]
                            ], k += W / 2, S += M / 2, R += W / 2, j += M / 2, l += h.moveTo({
                                x: c,
                                y: p
                            }), l += new be.b(D, I).smooth([{x: c, y: p}, {x: k, y: S}, {x: R, y: j}, {
                                x: d,
                                y: y
                            }]), l += h.lineTo({x: f, y: x}), l += new be.b(D, I).smooth([{x: f, y: x}, {
                                x: z,
                                y: E
                            }, {x: H, y: B}, {x: g, y: v}]), l += h.closePath()
                        }
                ...
                return Object(r.c)(t, e), t.prototype.draw = function () {
                    ...
                    if ("vertical" == this.orientation) {
                        var u = {x: (a - (v = C.relativeToValue(this.topWidth, a))) / 2 + r, y: t},
                            ...
                            d = {x: (a - x) / 2 + r, y: t + o},
                            y = {x: c.x + (p.x - c.x) / 2 + s * o, y: c.y + .5 * o},
                            g = {x: u.x + (d.x - u.x) / 2 - s * o, y: u.y + .5 * o},
                            f = h.lineTo(p),
                            m = "";
