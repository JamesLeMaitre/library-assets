...
!function () {
    ...
    var e = window.document,
        ...
        u = function (e, t, o) {
            var r = function (a) {
                if (t.test(e.readyState)) return f(e, "readystatechange", r), o(a)
            };
        ...
        w = function (e, t) {
            return "@media(prefers-color-scheme:" + e + "){" + m[v(m, t) ? t : e] + "}"
        },
        x = {
            "mark-github": {
                heights: {
        ...
        y = function (e, t) {
            e = ("" + e).toLowerCase().replace(/^octicon-/, ""), v(x, e) || (e = "mark-github");
            var o = t >= 24 && 24 in x[e].heights ? 24 : 16,
                r = x[e].heights[o];
        ...
        z = function (e, t) {
            ...
            if (!(o.push(t) > 1)) {
                var r = b((function () {
                    for (delete k[e]; t = o.shift();) t.apply(null, arguments)
                }));
                if (l) {
                    var n = new a;
                    ...
                    var c = g(i.document)("script", {async: !0, src: e + (/\?/.test(e) ? "&" : "?") + "callback=_"}),
                        d = function () {
                            i._ && i._({meta: {}})
                        };
        ...
        C = function (e, t, o) {
            var r = g(e.ownerDocument),
                ...
                n = "body{margin:0}a{text-decoration:none;outline:0}.widget{display:inline-block;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif;font-size:0;white-space:nowrap}.btn,.social-count{position:relative;display:inline-block;height:14px;padding:2px 5px;font-size:11px;font-weight:600;line-height:14px;vertical-align:bottom;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background-repeat:repeat-x;background-position:-1px -1px;background-size:110% 110%;border:1px solid}.btn{border-radius:.25em}.btn:not(:last-child){border-radius:.25em 0 0 .25em}.social-count{border-left:0;border-radius:0 .25em .25em 0}.widget-lg .btn,.widget-lg .social-count{height:20px;padding:3px 10px;font-size:12px;line-height:20px}.octicon{display:inline-block;vertical-align:text-top;fill:currentColor}" + function (e) {
                    ...
                    return m[v(m, t["no-preference"]) ? t["no-preference"] : "light"] + w("light", t.light) + w("dark", t.dark)
                }(t["data-color-scheme"]);
            ...
            var l = r("a", {
                    ...
                    innerHTML: y(t["data-icon"], /^large$/i.test(t["data-size"]) ? 16 : 14)
                }, [" ", r("span", {}, [t["data-text"] || ""])]),
                c = e.appendChild(r("div", {className: "widget" + (/^large$/i.test(t["data-size"]) ? " widget-lg" : "")}, [l])),
                s = l.hostname.replace(/\.$/, "");
            if (s.length < i.length || ("." + s).substring(s.length - i.length) !== "." + i) return l.href = "#", l.target = "_self", void o(c);
            var f = (" /" + l.pathname).split(/\/+/);
            if (((s === i || s === "gist." + i) && "archive" === f[3] || s === i && "releases" === f[3] && "download" === f[4] || s === "codeload." + i) && (l.target = "_top"), /^true$/i.test(t["data-show-count"]) && s === i) {
                var h, u;
                if (!f[2] && f[1]) h = u = "followers";
                else if (!f[3] && f[2]) u = "stargazers_count", h = "stargazers";
                else if (f[4] || "subscription" !== f[3])
                    if (f[4] || "fork" !== f[3]) {
                        if ("issues" !== f[3]) return void o(c);
                        u = "open_issues_count", h = "issues"
                    } else u = "forks_count", h = "network/members";
                else u = "subscribers_count", h = "watchers";
                var p = f[2] ? "/repos/" + f[1] + "/" + f[2] : "/users/" + f[1];
                z.call(this, "https://api.github.com" + p, (function (e, t) {
                    if (!e) {
                        var a = t[u];
                        c.appendChild(r("a", {
                            ...
                            rel: "noopener",
                            target: "_blank",
                            "aria-label": a + " " + u.replace(/_count$/, "").replace("_", " ").slice(0, a < 2 ? -1 : void 0) + " on GitHub"
                        }, [("" + a).replace(/\B(?=(\d{3})+(?!\d))/g, ",")]))
                    }
                    o(c)
                }))
        ...
        M = function (e) {
            return (F > 1 ? o.ceil(o.round(e * F) / F * 2) / 2 : o.ceil(e)) || 0
        },
        A = function (e, t) {
        ...
        L = function (t, r) {
            if (null != t && null != r)
                if (t.getAttribute && (t = function (e) {
                    ...
                    var a = p("span");
                    C(a.attachShadow({mode: "closed"}), t, (function () {
                        r(a)
                    }))
                } else {
                    var i = p("iframe", {
                    ...
                    var l = function () {
                        ...
                        f(i, "load", l), C.call(c, a, t, (function (e) {
                            var a = function (e) {
                                var t = e.offsetWidth,
                                    r = e.offsetHeight;
                            ...
                            i.parentNode.removeChild(i), h(i, "load", (function () {
                                A(i, a)
                            })), i.src = n + "#" + (i.name = function (e, t, o, r) {
    ...
    t.protocol + "//" + t.host + t.pathname === n ? C(e.body, d(window.name || t.hash.replace(/^#/, "")), (function () {
    })) : function (t) {
