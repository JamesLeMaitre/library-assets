...
(function(h) {
  ...
  n.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "Pas de données enrégistées !!",
      sInfo: "Liste: De _START_ à _END_ sur _TOTAL_ enrégistrements",/*Showing _START_ to _END_ of _TOTAL_ entries*/
      sInfoEmpty: "Pas d'enregistrement",
      sInfoFiltered: "(recherché dans  _MAX_ sauvegardes)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Afficher _MENU_ enrégistrements",
      sLoadingRecords: "Loading...",
      sProcessing: "Processing...",
      sSearch: "Rechercher:",
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "Pas de donnée correspondante !!"
    },
  ...
  n.ext = x = {
    ...
    classes: {},
    build:
      "bs4/jszip-2.5.0/pdfmake-0.1.36/dt-1.10.18/af-2.3.0/b-1.5.2/b-colvis-1.5.1/b-flash-1.5.2/b-html5-1.5.2/b-print-1.5.2/cr-1.5.0/fc-3.2.5/fh-3.1.4/kt-2.4.0/r-2.2.2/rg-1.0.3/rr-1.2.4/sc-1.5.0/sl-1.2.6",
    errMode: "alert",
    feature: [],
    search: [],
